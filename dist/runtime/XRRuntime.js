...
export class TransientSelection {
    onSelectStart(intersected) {
...
export class PersistentSelection {
    constructor() {
...
export default class XRRuntime extends Runtime {
    ...
    start() {
        const movementSystem = { tick: (delta) => this.updateMovement(delta) };
        const interactionSystem = { tick: () => this.updateInteraction() };
    ...
    setDummyColor(color) {
        const mat = this.dummyCube.material;
